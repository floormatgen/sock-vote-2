...
public /* abstract */ class Question: Identifiable {
  ...
  internal init(
    ...
    self.prompt = prompt
      ...
      precondition(
        meta != Question.self, "\(#function): Cannot create instace of abstract class Question")
    #endif
  }
  ...
  @discardableResult
  public func registerPluralityVote(_ vote: PluralityVote, participantToken: String) throws
    -> VoteResult
  {
  ...
  @discardableResult
  public func registerPreferentialVote(_ vote: PreferentialVote, participantToken: String) throws
    -> VoteResult
  {
