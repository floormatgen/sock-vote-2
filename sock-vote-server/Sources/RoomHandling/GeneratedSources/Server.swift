...
extension UniversalServer where APIHandler: APIProtocol {
  ...
  fileprivate func postRoomCreate(
    ...
    try await handle(
      ...
      deserializer: { request, requestBody, metadata in
        let headers: Operations.PostRoomCreate.Input.Headers = .init(
  ...
  fileprivate func getRoomCodeInfo(
    request: HTTPTypes.HTTPRequest,
    body: OpenAPIRuntime.HTTPBody?,
    metadata: OpenAPIRuntime.ServerRequestMetadata
  ) async throws -> (HTTPTypes.HTTPResponse, OpenAPIRuntime.HTTPBody?) {
    try await handle(
      ...
      deserializer: { request, requestBody, metadata in
        let path: Operations.GetRoomCodeInfo.Input.Path = .init(
          code: try converter.getPathParameterAsURI(
            in: metadata.pathParameters,
            name: "code",
            as: Components.Parameters.RoomCode.self
          ))
        let headers: Operations.GetRoomCodeInfo.Input.Headers = .init(
          accept: try converter.extractAcceptHeaderIfPresent(in: request.headerFields))
  ...
  fileprivate func postRoomCodeJoin(
    request: HTTPTypes.HTTPRequest,
    body: OpenAPIRuntime.HTTPBody?,
    metadata: OpenAPIRuntime.ServerRequestMetadata
  ) async throws -> (HTTPTypes.HTTPResponse, OpenAPIRuntime.HTTPBody?) {
    try await handle(
      ...
      deserializer: { request, requestBody, metadata in
        let path: Operations.PostRoomCodeJoin.Input.Path = .init(
          code: try converter.getPathParameterAsURI(
            in: metadata.pathParameters,
            name: "code",
            as: Components.Parameters.RoomCode.self
          ))
        let headers: Operations.PostRoomCodeJoin.Input.Headers = .init(
          accept: try converter.extractAcceptHeaderIfPresent(in: request.headerFields))
        let contentType = converter.extractContentTypeIfPresent(in: request.headerFields)
  ...
  fileprivate func getRoomCodeJoinRequests(
    request: HTTPTypes.HTTPRequest,
    body: OpenAPIRuntime.HTTPBody?,
    metadata: OpenAPIRuntime.ServerRequestMetadata
  ) async throws -> (HTTPTypes.HTTPResponse, OpenAPIRuntime.HTTPBody?) {
    try await handle(
      ...
      deserializer: { request, requestBody, metadata in
        let path: Operations.GetRoomCodeJoinRequests.Input.Path = .init(
          code: try converter.getPathParameterAsURI(
            in: metadata.pathParameters,
            name: "code",
            as: Components.Parameters.RoomCode.self
  ...
  fileprivate func postRoomCodeJoinRequests(
    request: HTTPTypes.HTTPRequest,
    body: OpenAPIRuntime.HTTPBody?,
    metadata: OpenAPIRuntime.ServerRequestMetadata
  ) async throws -> (HTTPTypes.HTTPResponse, OpenAPIRuntime.HTTPBody?) {
    try await handle(
      ...
      deserializer: { request, requestBody, metadata in
        let path: Operations.PostRoomCodeJoinRequests.Input.Path = .init(
          code: try converter.getPathParameterAsURI(
            in: metadata.pathParameters,
            name: "code",
            as: Components.Parameters.RoomCode.self
  ...
  fileprivate func getRoomCodeQuestion(
    request: HTTPTypes.HTTPRequest,
    body: OpenAPIRuntime.HTTPBody?,
    metadata: OpenAPIRuntime.ServerRequestMetadata
  ) async throws -> (HTTPTypes.HTTPResponse, OpenAPIRuntime.HTTPBody?) {
    try await handle(
      ...
      deserializer: { request, requestBody, metadata in
        let path: Operations.GetRoomCodeQuestion.Input.Path = .init(
          code: try converter.getPathParameterAsURI(
            in: metadata.pathParameters,
            name: "code",
            as: Components.Parameters.RoomCode.self
          ))
        let headers: Operations.GetRoomCodeQuestion.Input.Headers = .init(
          accept: try converter.extractAcceptHeaderIfPresent(in: request.headerFields))
  ...
  fileprivate func postRoomCodeQuestion(
    request: HTTPTypes.HTTPRequest,
    body: OpenAPIRuntime.HTTPBody?,
    metadata: OpenAPIRuntime.ServerRequestMetadata
  ) async throws -> (HTTPTypes.HTTPResponse, OpenAPIRuntime.HTTPBody?) {
    try await handle(
      ...
      deserializer: { request, requestBody, metadata in
        let path: Operations.PostRoomCodeQuestion.Input.Path = .init(
          code: try converter.getPathParameterAsURI(
            in: metadata.pathParameters,
            name: "code",
            as: Components.Parameters.RoomCode.self
  ...
  fileprivate func putRoomCodeQuestionID(
    request: HTTPTypes.HTTPRequest,
    body: OpenAPIRuntime.HTTPBody?,
    metadata: OpenAPIRuntime.ServerRequestMetadata
  ) async throws -> (HTTPTypes.HTTPResponse, OpenAPIRuntime.HTTPBody?) {
    try await handle(
      ...
      deserializer: { request, requestBody, metadata in
        ...
        let headers: Operations.PutRoomCodeQuestionID.Input.Headers = .init(
          roomAdminToken: try converter.getRequiredHeaderFieldAsURI(
            in: request.headerFields,
            name: "Room-Admin-Token",
            as: Components.Parameters.AdminToken.self
  ...
  fileprivate func deleteRoomCodeQuestionID(
    request: HTTPTypes.HTTPRequest,
    body: OpenAPIRuntime.HTTPBody?,
    metadata: OpenAPIRuntime.ServerRequestMetadata
  ) async throws -> (HTTPTypes.HTTPResponse, OpenAPIRuntime.HTTPBody?) {
  ...
  fileprivate func postRoomCodeQuestionIDVote(
    request: HTTPTypes.HTTPRequest,
    body: OpenAPIRuntime.HTTPBody?,
    metadata: OpenAPIRuntime.ServerRequestMetadata
  ) async throws -> (HTTPTypes.HTTPResponse, OpenAPIRuntime.HTTPBody?) {
    try await handle(
      ...
      deserializer: { request, requestBody, metadata in
        ...
        let headers: Operations.PostRoomCodeQuestionIDVote.Input.Headers = .init(
          participantToken: try converter.getRequiredHeaderFieldAsURI(
            in: request.headerFields,
  ...
  fileprivate func getRoomCodeQuestionIDResult(
    request: HTTPTypes.HTTPRequest,
    body: OpenAPIRuntime.HTTPBody?,
    metadata: OpenAPIRuntime.ServerRequestMetadata
  ) async throws -> (HTTPTypes.HTTPResponse, OpenAPIRuntime.HTTPBody?) {
    try await handle(
      ...
      deserializer: { request, requestBody, metadata in
        ...
        let headers: Operations.GetRoomCodeQuestionIDResult.Input.Headers = .init(
          accept: try converter.extractAcceptHeaderIfPresent(in: request.headerFields))
  ...
  fileprivate func getRoomCodeQuestionIDVotesInfo(
    request: HTTPTypes.HTTPRequest,
    body: OpenAPIRuntime.HTTPBody?,
    metadata: OpenAPIRuntime.ServerRequestMetadata
  ) async throws -> (HTTPTypes.HTTPResponse, OpenAPIRuntime.HTTPBody?) {
