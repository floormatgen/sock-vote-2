...
public enum Components {
    ...
    public enum Schemas {
        ...
        ///     The participant token provided is either missing or invalid
        ///   * `questionNotFound` -
        ...
        @frozen public enum ErrorType: String, Codable, Hashable, Sendable, CaseIterable {
            ...
            case roomParticipantTokenInvalid = "roomParticipantTokenInvalid"
        ...
        /// - Remark: Generated from `#/components/schemas/RoomParticipantError`.
        public struct RoomParticipantError: Codable, Hashable, Sendable {
            /// - Remark: Generated from `#/components/schemas/RoomParticipantError/value1`.
            public var value1: Components.Schemas.RoomError
            /// - Remark: Generated from `#/components/schemas/RoomParticipantError/value2`.
            public struct Value2Payload: Codable, Hashable, Sendable {
                /// The participant token associated with the request
                ///
                /// - Remark: Generated from `#/components/schemas/RoomParticipantError/value2/participantToken`.
                public var participantToken: Swift.String
                /// Creates a new `Value2Payload`.
                ///
                /// - Parameters:
                ///   - participantToken: The participant token associated with the request
            ...
            /// - Remark: Generated from `#/components/schemas/RoomParticipantError/value2`.
            public var value2: Components.Schemas.RoomParticipantError.Value2Payload
            /// Creates a new `RoomParticipantError`.
            ///
            /// - Parameters:
            ///   - value1:
            ///   - value2:
            public init(
                value1: Components.Schemas.RoomError,
                value2: Components.Schemas.RoomParticipantError.Value2Payload
            ) {
                self.value1 = value1
                self.value2 = value2
            }
    ...
    public enum Responses {
        ...
        public struct InvalidAdminToken: Sendable, Hashable {
            /// - Remark: Generated from `#/components/responses/InvalidAdminToken/content`.
            @frozen public enum Body: Sendable, Hashable {
                /// - Remark: Generated from `#/components/responses/InvalidAdminToken/content/application\/json`.
                case json(Components.Schemas.RoomAdminError)
                /// The associated value of the enum case if `self` is `.json`.
                ///
                /// - Throws: An error if `self` is not `.json`.
            ...
            /// Received HTTP response body
            public var body: Components.Responses.InvalidAdminToken.Body
            /// Creates a new `InvalidAdminToken`.
            ///
            /// - Parameters:
            ///   - body: Received HTTP response body
            public init(body: Components.Responses.InvalidAdminToken.Body) {
                self.body = body
            }
        }
        public struct InvalidParticipantToken: Sendable, Hashable {
            /// - Remark: Generated from `#/components/responses/InvalidParticipantToken/content`.
            @frozen public enum Body: Sendable, Hashable {
                /// - Remark: Generated from `#/components/responses/InvalidParticipantToken/content/application\/json`.
                case json(Components.Schemas.RoomParticipantError)
                /// The associated value of the enum case if `self` is `.json`.
                ///
                /// - Throws: An error if `self` is not `.json`.
                /// - SeeAlso: `.json`.
                public var json: Components.Schemas.RoomParticipantError {
                    get throws {
                        switch self {
                        case let .json(body):
                            return body
            ...
            /// Received HTTP response body
            public var body: Components.Responses.InvalidParticipantToken.Body
            /// Creates a new `InvalidParticipantToken`.
            ///
            /// - Parameters:
            ///   - body: Received HTTP response body
            public init(body: Components.Responses.InvalidParticipantToken.Body) {
                self.body = body
            }
        }
    ...
    public enum PutRoomCodeQuestionID {
        ...
        public struct Input: Sendable, Hashable {
            ...
            public struct Headers: Sendable, Hashable {
                ...
                public var roomAdminToken: Components.Parameters.AdminToken
                public var accept: [OpenAPIRuntime.AcceptHeaderContentType<Operations.PutRoomCodeQuestionID.AcceptableContentType>]
                /// Creates a new `Headers`.
                ///
                /// - Parameters:
                ///   - roomAdminToken: To ensure that only an admin is able to make privileged actions to a room. The token is provided to the room creator as a response to the create request.
                ...
                public init(
                    roomAdminToken: Components.Parameters.AdminToken,
                    accept: [OpenAPIRuntime.AcceptHeaderContentType<Operations.PutRoomCodeQuestionID.AcceptableContentType>] = .defaultValues()
                ) {
                    self.roomAdminToken = roomAdminToken
                    self.accept = accept
                }
    ...
    public enum PostRoomCodeQuestionIDVote {
        ...
        public struct Input: Sendable, Hashable {
            ...
            public struct Headers: Sendable, Hashable {
                ...
                public var accept: [OpenAPIRuntime.AcceptHeaderContentType<Operations.PostRoomCodeQuestionIDVote.AcceptableContentType>]
                /// Creates a new `Headers`.
                ///
                /// - Parameters:
                ...
                ///   - accept:
                public init(
                    participantToken: Components.Parameters.ParticipantToken,
                    accept: [OpenAPIRuntime.AcceptHeaderContentType<Operations.PostRoomCodeQuestionIDVote.AcceptableContentType>] = .defaultValues()
                ) {
                    self.participantToken = participantToken
                    self.accept = accept
                }
