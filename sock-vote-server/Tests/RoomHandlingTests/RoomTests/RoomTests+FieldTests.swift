...
extension RoomTests {
  ...
  struct FieldsTests {
    ...
    @Test(
      "Validate fields accepts valid fields",
      arguments: [
        [],
        ["Email"],
        ["Student ID", "Email"],
    ...
    static func runFieldValidationTests(
      ...
      #expect(
        room.validateFieldKeys(fieldKeys, missingFields: &missingFields, extraFields: &extraFields)
          == expected)
      ...
      #expect(
        room.validateFields(fields, missingFields: &missingFields, extraFields: &extraFields)
          == expected)
      #expect(missingFields == expectedMissing)
      #expect(extraFields == expectedExtra)
    }
